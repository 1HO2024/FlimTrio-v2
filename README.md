...
# 📃 프로젝트 정보
- 프로젝트 이름 : 필름트리오-v2
- 프로젝트 설명 : 기존 프로젝트 개선 버전입니다. (CI/CD 및 배포 예정, 알고리즘 실행시간 개선, 알고리즘 구조 변경,코드 리팩토링 등)
- 프로젝트 인원 : 1명
- 제작 기간 : 2025.
...
<details>
<summary><b>초기 아키텍처</b></summary>
<img width="800" height="617" alt="image" src="https://github.com/user-attachments/assets/6c388930-8c4c-4434-b735-929093ef4c43" />
</details>
...
> 기존 영화상세보기페이지 의 알고리즘 실행시간은 평균 15초 -> 대폭 감소 시킬 예정

### 2.예정사항
>  사용자 기반 추천 알고리즘 , UI/UX , 코드 리팩토링 , 이메일 인증 로직 , JWT 방식 , 메인화면 (사용자기반영화추천 JWT 인증 요청 구조 변경 ) 등
</r>
